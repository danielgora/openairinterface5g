...
int nas_config_helper(char *interfaceName, char *ipAddress, char *networkMask, char *broadcastAddress) {
...
int blocking_nas_config_helper(char *interfaceName, char *ipAddress, char *networkMask, char *broadcastAddress) {
  char command[200];
  command[0]='\0';
